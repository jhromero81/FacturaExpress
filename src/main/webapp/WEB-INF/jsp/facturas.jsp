<%-- Listado de facturas electrónicas - fiel al prototipo facturacion.html --%>
...
%>
      <tr data-numero="<%= numFac %>" data-cliente="<%= clienteStr.toLowerCase() %>" data-estado="<%= est %>">
        ...
        <td>
          <a class="btn-flat btn-small" style="color:#546e7a;padding:0 4px;" href="<%= ctx %>/facturas?action=descargarPdf&id=<%= f.getId() %>">
            <i class="material-icons tiny">picture_as_pdf</i> PDF
          </a>
          <a class="btn-flat btn-small" style="color:#1abc9c;padding:0 4px;" href="<%= ctx %>/facturas?action=descargarXml&id=<%= f.getId() %>">
